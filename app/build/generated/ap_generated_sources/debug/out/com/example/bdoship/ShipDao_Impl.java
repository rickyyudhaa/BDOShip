  ...
  public ShipDao_Impl(RoomDatabase __db) {
    ...
    this.__insertionAdapterOfShip = new EntityInsertionAdapter<Ship>(__db) {
      ...
      public String createQuery() {
        return "INSERT OR ABORT INTO `ship_table`(`id`,`type`,`material`,`inventory`,`cabins`,`cannonballs`,`cannons`,`lt`,`speed`,`turn`,`accel`,`brake`,`reload`) VALUES (nullif(?, 0),?,?,?,?,?,?,?,?,?,?,?,?)";
      }
      ...
      public void bind(SupportSQLiteStatement stmt, Ship value) {
        ...
        stmt.bindLong(4, value.getInventory());
        stmt.bindLong(5, value.getCabins());
        stmt.bindLong(6, value.getCannonballs());
        stmt.bindLong(7, value.getCannons());
        stmt.bindLong(8, value.getLt());
        stmt.bindLong(9, value.getSpeed());
        stmt.bindLong(10, value.getTurn());
        stmt.bindLong(11, value.getAccel());
        stmt.bindLong(12, value.getBrake());
        stmt.bindLong(13, value.getReload());
      }
    };
  }
  ...
  public List<Ship> getAll() {
    ...
    try {
      ...
      while(_cursor.moveToNext()) {
        ...
        _item = new Ship(_tmpType,_tmpMaterial,_tmpInventory,_tmpCabins,_tmpCannonballs,_tmpCannons,_tmpLt,_tmpSpeed,_tmpTurn,_tmpAccel,_tmpBrake,_tmpReload);
        final int _tmpId;
